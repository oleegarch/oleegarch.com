<template>
  ...
  <NuxtLayout>
    <main class="relative z-2 flex items-start w-full max-w-[1200px] mx-auto text-white py-15">
      <GlassContainer class="sticky top-15 flex-1 min-w-60 mr-8 py-12">
